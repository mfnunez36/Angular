...
export class ReactiveComponent implements OnInit {
  ...
  get validaPassword1() {
    return this.form.get('passwords.password1').invalid && this.form.get('passwords.password1').touched;
  }

  get validaPassword2() {
    const password1 = this.form.get('passwords.password1').value;
    const password2 = this.form.get('passwords.password2').value;
  ...
  crearform() {
    ...
    this.form = this.formBuilder.group({
      ...
      user    : ['', , this.validadoresService.existeUser]
      ...
      passwords: this.formBuilder.group({
        password1: ['', [ Validators.required, this.validadoresService.validaPassword ] ],
        password2: ['', [ Validators.required, this.validadoresService.validaPassword ] ]
      }),
      // tambien tenemos arreglos
      hobbies: this.formBuilder.array([])
    }, {
      validators: this.validadoresService.validaPasswordsIguales('password1', 'password2')
    });
  }
